...
<body style="width: 100%; display: flex; flex-direction: column; align-items: center;">
	...
	<div style="width: 800px; padding-left: 20px;">
		<form action="SellCPUResult.jsp" style="padding-top: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>CPU</h1>
			<div style="padding-top: 2px; padding-bottom: 2px; display: flex; justify-content: space-between;"><label>Model Name: </label><input type="text" name="modelName"></div>
			...
			<div style="padding-top: 2px; padding-bottom: 2px;"><input type="submit" value="sell"></div>
			<input type="hidden" name="partType" value="CPU">
		</form>
		<form action="SellGPUResult.jsp" style="padding-top: 5px; padding-bottom: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>GPU</h1>
			<div style="padding-top: 2px; padding-bottom: 2px; display: flex; justify-content: space-between;"><label>Model Name: </label><input type="text" name="modelName"></div>
		...
		<form action="SellHardDriveResult.jsp" style="padding-top: 5px; padding-bottom: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>Hard Drive</h1>
			<div style="padding-top: 2px; padding-bottom: 2px; display: flex; justify-content: space-between;"><label>Model Name: </label><input type="text" name="modelName"></div>
		...
		<form action="SellMotherboardResult.jsp" style="padding-top: 5px; padding-bottom: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>Motherboard</h1>
			<div style="padding-top: 2px; padding-bottom: 2px; display: flex; justify-content: space-between;"><label>Model Name: </label><input type="text" name="modelName"></div>
		...
		<form action="SellRAMResult.jsp" style="padding-top: 5px; padding-bottom: 5px; display: flex; flex-direction: column; width: 300px;">
			<h1>RAM</h1>
			<div style="padding-top: 2px; padding-bottom: 2px; display: flex; justify-content: space-between;"><label>Model Name: </label><input type="text" name="modelName"></div>
