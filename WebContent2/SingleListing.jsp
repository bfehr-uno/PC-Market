	...
	<div class="container">
		<div class="listing">
			...
			if (partType.equals("CPU")) {
				...
				%>
				<div class="leftside">
					<div class="cpu-model">Model: <%=cpu.getManufacturer() + " " + cpu.getModelName()%></div>
			...
			<%
				...
				<div class="leftside">
					<div class="gpu-model">Model: <%=gpu.getManufacturer() + " " + gpu.getModelName()%></div>
			...
			<%
				...
				<div class="leftside">
					<div class="harddrive-model">Model: <%=hardDrive.getManufacturer() + " " + hardDrive.getModelName()%></div>
			...
			<%
				...
				%>
				<div class="leftside">
					<div class="motherboard-model">Model: <%=motherboard.getManufacturer() + " " + motherboard.getModelName()%></div>
